...
const AIApiDocs = () => {
  ...
  const endpoints: EndpointDefinition[] = [
    ...
    },
    {
      ...
      body: JSON.stringify(
        { name: 'OpenAI Production', provider: 'openai', apiKey: 'sk-...', defaultModel: 'gpt-4' },
        null,
        2
      ),
      response: JSON.stringify(
    ...
    },
    {
      ...
      response: JSON.stringify(
        { id: 'comp_123', name: 'OpenAI Updated', defaultModel: 'gpt-4-turbo', isActive: true },
        null,
        2
      ),
    },
    ...
    },
    {
      ...
      response: JSON.stringify(
        { id: 'chat_123', title: 'My Chat', model: 'gpt-4', totalTokens: 0, messages: [] },
        null,
        2
      ),
    },
      ...
      response: JSON.stringify(
        {
          ...
          model: 'gpt-4',
          messages: [
            { role: 'user', content: 'Hello', timestamp: '2024-01-01T12:00:00Z', tokenCount: 5 },
          ],
          totalTokens: 500,
        },
        null,
    ...
    },
    {
      ...
      body: JSON.stringify({ message: 'Hello, how can you help me today?' }, null, 2),
      response: JSON.stringify(
        {
    ...
    },
    {
      ...
      body: JSON.stringify({ title: 'Updated Chat Title', maxHistoryMessages: 100 }, null, 2),
      response: JSON.stringify(
        { id: 'chat_123', title: 'Updated Chat Title', maxHistoryMessages: 100 },
        null,
        2
      ),
    },
    ...
    },
    {
      ...
      body: null,
      response: JSON.stringify({ totalChats: 10, totalMessages: 100, totalTokens: 5000 }, null, 2),
    },
  ];
