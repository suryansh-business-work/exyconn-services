...
const EnvKeysDashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      setLoading(true);
      try {
        const data = await envAppApi.getStats(
          selectedOrg.id,
    ...
    <Box>
      ...
      <Paper variant="outlined" sx={{ p: 3, mt: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Manage environment variables securely across your applications. Create
          applications for different environments (development, staging,
          production) and store sensitive configuration values with secret
          masking.
        </Typography>
      </Paper>
    </Box>
