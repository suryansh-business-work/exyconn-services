...
const FilePreviewItem = ({
  ...
  return (
    <Paper sx={{ p: 1.5, mb: 1, display: 'flex', alignItems: 'center', gap: 2 }}>
      <Box
        sx={{
          width: 40,
          height: 40,
      ...
      <Box sx={{ flex: 1, minWidth: 0 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          {status === 'success' && <CheckCircle color="success" fontSize="small" />}
      ...
      <IconButton size="small" onClick={onRemove} disabled={status === 'uploading'}>
