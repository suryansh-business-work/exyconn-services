...
const OrgDashboard = () => {
  ...
  return (
    <Box>
      <PageBreadcrumb items={[{ label: 'Home', href: '/' }, { label: selectedOrg.orgName }]} />
        ...
        <Box>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 0.5 }}>
            ...
            <Chip
              ...
              size="small"
              color={selectedOrg.orgType === 'Service' ? 'primary' : 'secondary'}
      ...
      {selectedOrg.orgApiKeys && selectedOrg.orgApiKeys.length > 0 && (
        <Box sx={{ mt: 3 }}>
          <Typography variant="h6" sx={{ fontWeight: 600, fontSize: 14, mb: 2 }}>
            API Keys
          </Typography>
          <Grid container spacing={2}>
