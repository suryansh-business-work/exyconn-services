...
const SiteStatusApiDocs = () => {
  ...
  "createdAt": "2024-01-15T10:00:00.000Z"
    ...
    },
    {
      ...
      path: `/organizations/${orgId}/site-status/monitors`,
      description:
        "List all site monitors with pagination, search, and filtering.",
      body: null,
      response: `{
  "data": [
    {
  ...
  "pageInfo": {
    ...
    },
    {
      ...
      description:
        "Get check history with filtering by monitor, status, and date range.",
      body: null,
      response: `{
  "data": [
    {
  ...
  "pagination": {
    ...
    },
    {
      ...
      description:
        "Get aggregated statistics including uptime percentage and response times.",
      body: null,
      response: `{
  "totalMonitors": 5,
  "activeMonitors": 4,
